          	...
          	<form class="form-horizontal tasi-form" id='update-college-form'>
            	<div class="form-group">
                	<label class="col-sm-2 col-sm-2 control-label">College Code</label>
                  	<div class="col-sm-10">
                    	<input type="text" name='abrr' value="{{ $college->abrr }}" placeholder='Enter College Abbrevation' class="form-control" required>
                  	</div>
              	</div>
	            <div class="form-group">
	                <label class="col-sm-2 col-sm-2 control-label">College Name</label>
	                <div class="col-sm-10">
	                    <input type="text" name='name' value="{{ $college->name }}" placeholder='Enter Middle Name' class="form-control" required>
	                </div>
	            </div>
